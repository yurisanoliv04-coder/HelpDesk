...
import { getMyTickets } from '@/lib/dashboard/fetchers/tickets'
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
        <p className="section-label">── {isCollaborador ? 'MEUS CHAMADOS' : 'ATRIBUÍDOS A MIM'}</p>
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <p style={{ fontSize: 11, color: 'var(--text-dim)', marginTop: 2 }}>{ticket.category.name}</p>
                    </div>
                    <div style={{ flexShrink: 0, display: 'flex', alignItems: 'center', gap: 10 }}>
                      <span style={{
