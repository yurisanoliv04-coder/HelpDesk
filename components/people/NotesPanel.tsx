...
import { addUserNote, deleteUserNote } from '@/app/(app)/people/[id]/actions'
...
export default function NotesPanel({ userId, notes: initialNotes, currentUserId, canEdit, isAdmin }: Props) {
  ...
  function handleAdd() {
    ...
    startTransition(async () => {
      await addUserNote(userId, trimmed)
      // After server revalidates, the page will re-render and pass fresh notes via props.
      ...
      {canEdit && (
        <div style={{
          ...
          <div style={{
            ...
            color: '#2d4060', letterSpacing: '0.1em', marginBottom: 10,
          }}>
            NOVA NOTA
          </div>
          <textarea
            ...
            placeholder="Escreva uma nota sobre este usuário… (Ctrl+Enter para enviar)"
            rows={3}
            style={{
              width: '100%', background: 'rgba(255,255,255,0.03)',
              border: '1px solid rgba(255,255,255,0.08)',
              borderRadius: 8, padding: '10px 12px',
              color: '#c8d6e5', fontSize: 13, lineHeight: 1.6,
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10, gap: 12 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    ...
                    <div style={{
                      ...
                      background: 'rgba(0,217,184,0.1)', border: '1px solid rgba(0,217,184,0.2)',
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    <span
                      style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 9, color: '#2d4060', cursor: 'default' }}
                      title={fmt(note.createdAt)}
                    >
