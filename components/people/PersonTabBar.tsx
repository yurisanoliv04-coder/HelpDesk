...
import { User, ArrowLeftRight, StickyNote, Paperclip } from 'lucide-react'
...
export default function PersonTabBar({ userId, activeTab, counts = {} }: Props) {
  return (
    <div style={{
